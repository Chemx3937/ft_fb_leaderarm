...
from PyQt5.QtGui import QColor, QKeySequence, QPainter, QPen, QTextCursor
from PyQt5.QtWidgets import (
    QApplication, QComboBox, QGridLayout, QGroupBox,
    QHBoxLayout, QHeaderView, QLabel, QMainWindow, QMessageBox, QPushButton,
    QShortcut, QSplitter, QTabWidget, QTableWidget, QTableWidgetItem, QTextEdit,
    QVBoxLayout, QWidget,
)
...
def main():
    ...
    def spin_ros():
        try:
            ...
            if rclpy.ok():
                on_event(
                    "ERROR", "GUI", f"ROS callback 오류: {exc}", dedup_sec=5.0)
